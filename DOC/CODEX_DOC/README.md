...
5. `04_研发文档/` 用于数据结构、导入导出规范和关键业务流程文档
...
4. `04_研发文档/` 用于数据规范、关键业务流程和导入导出规范等研发正文
5. `06_过程文档/02_历史计划/` 用于归档旧版详细实施计划或拆分前文档，不再占用当前计划主目录
6. 对强交互工作台，技术方案选型必须以后续原型目标和交互验证为输入，不允许绕过原型直接冻结交互栈
7. 当某个 `WBS` 节点的主要价值是“规范本身”时，应优先把 `研发文档/` 下的规范正文作为主要成果物，而不是只保留抽象 issue 标题
...
19. [13-WBS-3.1-知识库主视图增强-研制计划.md](/home/wgw/CodexProject/NovelStoryManager/DOC/CODEX_DOC/03_研制计划/13-WBS-3.1-知识库主视图增强-研制计划.md)
20. [15-WBS-4.1-关系图工作台-研制计划.md](/home/wgw/CodexProject/NovelStoryManager/DOC/CODEX_DOC/03_研制计划/15-WBS-4.1-关系图工作台-研制计划.md)
21. [17-WBS-5.1-多轨编排视图-研制计划.md](/home/wgw/CodexProject/NovelStoryManager/DOC/CODEX_DOC/03_研制计划/17-WBS-5.1-多轨编排视图-研制计划.md)
22. [19-WBS-6.1-观察输出层-研制计划.md](/home/wgw/CodexProject/NovelStoryManager/DOC/CODEX_DOC/03_研制计划/19-WBS-6.1-观察输出层-研制计划.md)
23. GitHub Project Roadmap: <https://github.com/users/wgwtest/projects/3>
...
5. `04_研发文档/`：当前下设 `01_数据规范/`
6. `05_测试文档/`：下设 `01_自测报告/`、`02_验收清单/`、`03_验收记录/`、`04_验收结论/`
7. `06_过程文档/`：当前下设 `01_会话交接/`、`02_历史计划/`
